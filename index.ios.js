...
export default class Pangolins extends Component {
    ...
    renderScene(route, navigator) {
        if(route.question.question){
            ...
            return ( <Answer
                     answer={ route.question.answer }
                     questionCount={ route.questionCount }
                     newGame={() => {
                         navigator.popToTop();
                     }}
                     addNewQuestion={(newAnswer, newQuestion, newQuestionIsYes) => {
                         const yes =  { answer: newQuestionIsYes ? newAnswer : route.question.answer };
                         const no = { answer: newQuestionIsYes ? route.question.answer : newAnswer };
                         route.question = {
